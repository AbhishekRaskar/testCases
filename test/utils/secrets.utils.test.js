...
describe('Secrets Utils', function() {
    ...
    describe('getEnvironmentVariables - AWS Environment', () => {
        ...
        it('should return AWS secrets when in AWS environment', async () => {
            ...
            expect(mockSecretsManager.getSecretValue.calledWith({
    ...
    describe('validateEnvironmentVariables', () => {
        it('should not throw when all required variables are present', () => {
            ...
            const requiredVars = ['SONARQUBE_BASE_URL', 'SONARQUBE_TOKEN', 'JIRA_BASE_URL', 'JIRA_USERNAME', 'JIRA_API_TOKEN'];

            expect(() => validateEnvironmentVariables(envVars, requiredVars)).to.not.throw();
        });
        ...
        it('should throw error when required variables are missing', () => {
            ...
            expect(() => validateEnvironmentVariables(envVars, requiredVars))
                .to.throw('Missing required environment variables: SONARQUBE_TOKEN, JIRA_USERNAME, JIRA_API_TOKEN');
        });
        ...
        it('should handle empty environment variables object', () => {
            ...
            expect(() => validateEnvironmentVariables(envVars, requiredVars))
                .to.throw('Missing required environment variables: SONARQUBE_BASE_URL, SONARQUBE_TOKEN');
        });
